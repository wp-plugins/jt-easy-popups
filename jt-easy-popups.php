...
<div id="jt_pop_admin_page">
    ...
    <div id="jtpop_footer">
        <div id="footer_help">
            <ul>
                <li>'JT BASIC SETTINGS'을 먼저 설정, 저장하신 후 팝업을 추가하여 설정합니다.</li>
    ...
    foreach ($fivesdrafts as $key => $value) {
        ...
        ?>
            <div class="jtpop_bg_page <?php echo $popup_style. " " . $popup_shadow; ?>">
                ...
                <?php if($value->closecolor == "jtpop_black" && get_option('JTPOP_popup_style') == "type1" || $value->closecolor == NULL && get_option('JTPOP_popup_style') == ""){
