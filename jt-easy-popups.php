...
function JTPOP_show_html(){
    ...
    foreach ($fivesdrafts as $key => $value) {
        ...
        <?php
            ...
            $popup_shadow = "shadow";
            if(get_option('JTPOP_popup_shadow') == "noshadow") $popup_style = "noshadow";
        ?>
            <div class="jtpop_bg_page <?php echo $popup_style. " " . $popup_shadow; ?>">
                <div class="popclose"><img src="
                <?php if(($value->closecolor == "jtpop_black" || $value->closecolor == "") && get_option('JTPOP_popup_style') == "type1" ){
                        echo Plugins_url('/img/close_pop.png', __FILE__); 
                      }
                      if($value->closecolor == "jtpop_white" && get_option('JTPOP_popup_style') == 'type1'){
                        echo Plugins_url('/img/close_pop_white.png', __FILE__);
                      }
                      if(get_option('JTPOP_popup_style') == 'type2'){
                ...
                <div class="popip_footer <?php if($value -> radius != NULL) echo 'footer_radius_' . $value -> radius; ?>">
                    <span class="notoday"><img src="
                        <?php if( $value->closecolor == "jtpop_black" && get_option('JTPOP_popup_style') == "type1"){
